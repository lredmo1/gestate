...
function CanvasMain({currentColor, currentWidth}) {
  ...
  useEffect(()=>{
    ...
    async function asyncCall() {
      ...
      console.log(`this is the old ${awaitingDrawing}`)
